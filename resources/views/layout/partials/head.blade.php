...
<meta content="anjani" name="author" />
<!-- end: META -->
<!-- start: MAIN CSS -->
...
<link rel="stylesheet" href="{{ asset('assets/plugins/sweetalert/lib/sweet-alert.css') }}"/>
<!-- end: CORE CSS -->
<link rel="shortcut icon" href="{{ asset('assets/icon/favicon.ico') }}" />
<link rel="stylesheet" href="{{ asset('assets/stylesheets/admin-style.css') }}"/>
<link rel="stylesheet" href="{{ asset('assets/stylesheets/global-style.css') }}"/>
<link rel="stylesheet" href="{{ asset('assets/stylesheets/libcvm.css') }}"/>
